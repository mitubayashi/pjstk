...
function makeMenuHtml( $fileName, &$button_ini )
{
    ...
    else
    {
        ...
        // 遷移先URLを含めてメニュー項目作成
		$menu_html .= '<li class="main">';
       $key_column = $button_ini[$fileName]['key_column'];
	   if($key_column != "")
	   {
		   $menu_html .= '<a href="main.php?'.$button_name.'='.$urlencode.'&'.$key_column.'='.$_SESSION[$key_column].'">'.$button_value.'</a>';
	   }   
	   else
	   {
...
function makeAllMenu()
{
	...
	//------------------------//
	$button_count = 0;
	//$button_html = '<div id="contents" class="content" ><ul class="nav"><li class="main"><a href="main.php?TOP_5">TOP</a></li>';
	$button_html = '<ul class="nav"><li class="main"><a href="main.php?SHUTAIKIN_1_button">TOP</a></li>';
	...
	//$button_html .='<li class="main"><a href="login.php">ログアウト</a></li><!--nav--></ul></div>';
	$button_html .='<li class="main"><a href="loginout.php">ログアウト</a></li><!--nav--></ul>';
